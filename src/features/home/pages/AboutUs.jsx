...
//             <span className="text-xs font-black text-pink-500 uppercase tracking-widest">Our Story & Mission</span>
//           </div>
          
//           <h1 className="text-6xl md:text-8xl font-black text-slate-800 mb-8 tracking-tighter">
//             Your Mind is a Garden. <br />
//             <span className="gradient-text-pink">Let's Help it Bloom.</span>
//           </h1>
...
//                    <h2 className="text-4xl font-black text-slate-800 mb-6">Our Mission</h2>
...
//                 <div>
//                     <h4 className="font-black text-xl text-slate-800">Approachability First</h4>
...
//                 <div>
//                     <h4 className="font-black text-xl text-slate-800">Radical Privacy</h4>
...
//                 <div>
//                     <h4 className="font-black text-xl text-slate-800">Science + Joy</h4>
...
//             <h2 className="text-4xl md:text-5xl font-black text-slate-800 mb-4">Inside the Bloom Box</h2>
//             <p className="text-slate-500 font-bold uppercase tracking-widest text-sm">Everything you need to nurture your neurodiversity</p>
//           </div>
...
//               <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight">Your Secrets are Safe <br /><span className="text-blue-400">Under our Umbrella.</span></h2>
...
//                   <p className="text-xs text-slate-400 mt-1">Log moods with a cup of peace.</p>
//                </div>
...
//                   <p className="text-xs text-slate-400 mt-1">Go at your own pace, ghost the stress.</p>
//                </div>
//             </div>
...
//                    />
//                 </div>
//                 <div className="absolute bottom-10 left-10 right-10 p-8 bg-white/40 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-lg">
...
//               className="bg-pink-500 text-white px-14 py-6 rounded-[2.5rem] font-black text-2xl shadow-2xl shadow-pink-200 hover:bg-pink-600 hover:scale-110 active:scale-95 transition-all flex items-center gap-3 mx-auto"
//             >
//               Start My Bloom 🌸
//             </button>
//           </div>
          ...
          <div className="relative">
             <div className="bg-gradient-to-tr from-pink-200 via-purple-100 to-blue-200 h-[500px] rounded-[4rem] shadow-2xl relative overflow-hidden group">
                ...
                <div className="absolute bottom-10 left-10 right-10 p-8 bg-white/40 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-lg font-playfair">
                   <p className="text-slate-800 font-black text-2xl italic leading-tight">
                     "Healing is not a destination — it’s a journey. We’re here to walk with you." - Admin
                   </p>
                </div>
             </div>
          </div>
